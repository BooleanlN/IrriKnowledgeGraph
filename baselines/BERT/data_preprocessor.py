...
def create_tag2idx():
    ...
    full_tags=['B-PER', 'E-PER', 'M-PER', 'B-RIV', 'E-RIV', 'M-RIV', 'B-LAK', 'E-LAK', 'M-LAK', 'B-RES', 'E-RES','M-RES',
               'B-ORG', 'E-ORG', 'M-ORG', 'B-HYD', 'E-HYD', 'M-HYD', 'B-DAM', 'E-DAM', 'M-DAM', 'B-OTH', 'E-OTH','M-OTH',
               'B-LOC', 'E-LOC', 'M-LOC', 'B-TER', 'E-TER', 'M-TER']
...
if __name__ == '__main__':
    ...
    # [Info] Get 477 instances from ../Data/dev.char.bmes
